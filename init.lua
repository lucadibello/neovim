...
-- Always show line numbers + use relative line numbers to easier jumps
vim.opt.number = true
...
-- Exit terminal mode using <Esc><Esc>
...
require('lazy').setup({
  ...
  -- Configure debugger
  -- WARNING: For now is disabled, will be enables as soon as I need it!
  -- require 'kickstart.plugins.debug',

  -- Automatically indents blank lines
  require 'kickstart.plugins.indent_line',

  -- Automatically inserts paired characters (brakets, quotes, ...)
  require 'kickstart.plugins.autopairs',

  -- Import any other custom plugin!
